...
public static class ChainDefinitionDefaults
{
    ...
    [
        ...
        Evm("bsc-testnet", "BNB Smart Chain Testnet", "BSC Testnet", 97, "tBNB", "https://97.rpc.thirdweb.com", "https://testnet.bscscan.com", 6, enabled: false),
        ...
        new ChainDefinition
        {
            ...
            Enabled = false,
            IconAsset = "/images/phantom-wallet.svg", SolanaCluster = "testnet", NativeCurrencyName = "Solana", NativeCurrencySymbol = "SOL",
    ...
    private static ChainDefinition Evm(string key, string name, string shortName, int chainId, string symbol, string rpc, string explorer, int order, bool legacy = false, bool enabled = true) => new()
    {
        Key = key,
        DisplayName = name,
        ShortName = shortName,
