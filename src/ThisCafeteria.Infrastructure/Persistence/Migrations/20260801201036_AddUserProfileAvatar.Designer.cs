...
namespace ThisCafeteria.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260801201036_AddUserProfileAvatar")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ThisCafeteria.Domain.Entities.AgenticJobDeferredEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ChainKey", "ContractAddress", "TransactionHash", "LogIndex")
                        .IsUnique()
                        .HasDatabaseName("IX_AgenticJobDeferredEvents_LogIdentity");

                    b.ToTable("AgenticJobDeferredEvents");
                });
            ...
            modelBuilder.Entity("ThisCafeteria.Domain.Entities.UserProfile", b =>
                {
                    b.OwnsOne("ThisCafeteria.Domain.Avatars.RobotAvatar", "Avatar", b1 =>
                        {
                            b1.Property<Guid>("UserProfileId");

                            b1.Property<string>("Backdrop")
                                .IsRequired()
                                .HasMaxLength(32);
                            ...
                            b1.Property<string>("Visor")
                                .IsRequired()
                                .HasMaxLength(32);

                            b1.Property<string>("Wear")
                                .IsRequired()
                                .HasMaxLength(32);
